...
TextToSVG.load('impact.otf', function(err, textToSVG) {
    input.addEventListener('input', (e) => {
        ...
        let out = `<span style="height: 2.6em; display: inline-block; background-image: url('${dataURI}'); aspect-ratio: ${metrics.width / metrics.height}; background-size: contain; background-repeat: no-repeat; background-position: left bottom; transform: translateY(.23em);"></span>`
        console.log(out)
